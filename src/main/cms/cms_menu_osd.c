...
static const OSD_Entry menuOsdElemsEntries[] =
{
    ...
    OSD_ELEMENT_ENTRY("WM HEADING", OSD_WM_HEADING),
    OSD_ELEMENT_ENTRY("WM DISTANCE", OSD_WM_DISTANCE),
    OSD_ELEMENT_ENTRY("WM SPEED", OSD_WM_SPEED),
    OSD_ELEMENT_ENTRY("WM ALTITUDE", OSD_WM_ALTITUDE),
    OSD_BACK_AND_END_ENTRY,
};
